...
export default function HomePage() {
  ...
  const hero = {
  "heading": "Transform Your Seattle Home with Custom Mini Closets",
  "subheading": "Maximize storage space and organize your belongings with expertly designed compact closet solutions.",
  "ctaText": "Get Quote",
  "ctaLink": "/contact"
};
  const features = [
  {
    "icon": "📏",
    "title": "Space-Optimized Design Solutions",
    "description": "Maximize storage efficiency in compact spaces with custom-designed mini closets tailored to your specific room dimensions and needs."
  }
];
  const services = [
  {
    "title": "Custom Mini Closet Design",
    "description": "Personalized compact closet solutions tailored to your space, style preferences, and storage needs with expert consultation and planning.",
    "link": "/services/custom-mini-closet-design"
  }
];
