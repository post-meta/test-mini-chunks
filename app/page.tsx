...
export default function HomePage() {
  ...
  const hero = {
  "heading": "Transform Your Seattle Home with Custom Mini Closet Solutions",
  "subheading": "Maximize space and organization with expertly designed closets tailored for Pacific Northwest living",
  "ctaText": "Get Started",
  "ctaLink": "/contact"
};
  const features = [
  {
    ...
    "description": "Professional assessment of your closet dimensions and layout to maximize storage capacity and functionality within any space constraints."
  }
];
  const services = [
  {
    "title": "Custom Mini Closet Design",
    "description": "Personalized compact storage solutions tailored to your space and lifestyle needs with expert design consultation and installation.",
